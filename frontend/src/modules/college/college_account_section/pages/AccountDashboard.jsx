...
import { getAccountDashboardStats, getFees, getPayments, getPendingStudents } from '../api/account';
...
const mockPending = [
  { id: 1, name: 'Rohan Singh', class_name: 'B.Sc. 2nd Year', roll_number: 'R-023', pending_amount: 15000, due_date: '2024-03-15' },
  { id: 2, name: 'Sia Varma', class_name: 'B.A. 1st Year', roll_number: 'R-041', pending_amount: 5500, due_date: '2024-03-31' },
];
const mockFees = [
...
export default function AccountDashboard() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const [sr, fr, pr, dr] = await Promise.allSettled([getAccountDashboardStats(), getFees(), getPayments(), getPendingStudents()]);
