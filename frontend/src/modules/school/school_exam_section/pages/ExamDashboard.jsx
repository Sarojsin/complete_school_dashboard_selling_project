...
import { getProfile, getExams, getResults, getNotices } from '../api/examSection';
...
// ─── Mock data ────────────────────────────────────────────────────────────────
const mockExams = [
  { id: 1, name: 'Mid-Term Physics', class_name: 'Grade 11', subject: 'Physics', date: '2024-04-10', duration: 180, status: 'scheduled' },
  { id: 2, name: 'Mathematics Final', class_name: 'Grade 10', subject: 'Mathematics', date: '2024-04-14', duration: 120, status: 'scheduled' },
  { id: 3, name: 'English Unit Test', class_name: 'Grade 9', subject: 'English', date: '2024-03-28', duration: 90, status: 'completed' },
];
const mockResults = [
  { id: 1, exam_name: 'Chemistry Practical', class_name: 'Grade 12', subject: 'Chemistry', created_at: '2024-03-25' },
  { id: 2, exam_name: 'Hindi Mid-Term', class_name: 'Grade 9', subject: 'Hindi', created_at: '2024-03-20' },
];
const mockNotices = [
  { id: 1, title: 'Board Exam Timetable Released', content: 'The board examination schedule for Class 12 has been finalized.', created_at: '2024-03-28' },
