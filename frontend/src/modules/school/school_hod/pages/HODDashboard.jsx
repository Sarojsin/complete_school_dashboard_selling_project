...
export default function HODDashboard() {
  ...
  const navigationItems = [
    { icon: Users,    title: 'Faculty Management', desc: 'View all teachers in your dept.',  link: '/hod/teachers', color: 'blue' },
    { icon: GraduationCap, title: 'Student Profiles',  desc: 'Monitor student progress.',      link: '/hod/students', color: 'emerald' },
    { icon: BookOpen, title: 'Course Catalog',     desc: 'Manage departmental courses.',    link: '/hod/courses',  color: 'purple' },
    { icon: BarChart2,title: 'Academic Reports',   desc: 'Analytics and performance logs.', link: '/hod/reports',  color: 'amber' },
  ];

  const recentUpdates = [
    { id: 1, title: 'New course submitted for review', time: '2 hours ago', type: 'academic' },
    { id: 2, title: 'Teacher leave request — Dr. Mehta', time: '4 hours ago', type: 'hr' },
  ...
  const stats = {
    department_name: data?.department    || storedUser.department || 'Science',
    total_teachers: data?.total_teachers || 14,
