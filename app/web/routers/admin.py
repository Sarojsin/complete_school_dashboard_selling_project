...
async def _get_admin_stats(db: AsyncSession):
    ...
    from app.models.models import Student, Teacher, User as UserModel, Parent, Course, FeeRecord, Notice
...
async def admin_feature_detail(
    ...
    """
    from app.repositories.feature_repository import FeatureRepository, FeatureRolePermissionRepository, AdminAuditLogRepository
...
async def admin_audit_logs(
    ...
    """
    from app.repositories.feature_repository import AdminAuditLogRepository
...
async def admin_finance(
    ...
    """
    from app.models.models import FeeRecord, FeeStructure
    from sqlalchemy import select
