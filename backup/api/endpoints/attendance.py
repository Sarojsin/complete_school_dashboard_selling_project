...
from backup.dependencies.auth import get_current_teacher, get_current_student, get_current_user
...
from backup.schemas.misc import AttendanceCreate, AttendanceResponse
