...
from backup.dependencies.auth import get_current_authority
from backup.models.models import User, Student, Teacher, Course, Assignment, Attendance, Grade, FeeRecord, UserRole, Notice
...
from backup.schemas.misc import (
...
async def get_all_students(
    ...
    ⚠️ DEPRECATED: This endpoint will be moved to /api/v1/school/students/ in the future.
    Please update your integrations.
    """
    # Add deprecation headers
    response.headers["X-Deprecated"] = "true"
    response.headers["X-Migrate-To"] = "/api/v1/school/students/"
...
async def get_all_teachers(
    ...
    ⚠️ DEPRECATED: This endpoint will be moved to /api/v1/school/teachers/ in the future.
    Please update your integrations.
    """
    # Add deprecation headers
    response.headers["X-Deprecated"] = "true"
    response.headers["X-Migrate-To"] = "/api/v1/school/teachers/"
    response.headers["X-Sunset-Date"] = "2026-04-30"
