...
School Students API
===================
Student endpoints for school mode.
"""
...
from backup.dependencies.auth import get_current_student, get_current_user
...
from backup.schemas.misc import StudentResponse, StudentUpdate, CourseResponse, TestForStudent
from backup.models.models import Assignment, Grade, Attendance, FeeRecord, AssignmentSubmission, Note, Video, Schedule
