...
from backup.modules.school.library.schemas import (
    BookCreate,
    BookUpdate,
    BookLoanCreate
)

router = APIRouter(prefix="/library", tags=["School Library"])


def get_service(db: AsyncSession = Depends(get_async_db)) -> LibraryService:
