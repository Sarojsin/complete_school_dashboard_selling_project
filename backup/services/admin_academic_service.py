...
from backup.models.models import Course, Teacher
from backup.models.department_models import Department
from backup.api.schemas.admin.academic import (
    CourseCreateRequest, CourseUpdateRequest,
    DepartmentCreateRequest, DepartmentUpdateRequest
)
from backup.repositories.admin_academic_repository import AdminAcademicRepository
from backup.core.exceptions import NotFoundError, ValidationError
...
class AdminAcademicService:
    ...
    async def get_teacher_or_raise(db: AsyncSession, teacher_id: int) -> Teacher:
        from backup.repositories.user_repository import UserRepository # Teacher is tied to user conceptually, but we have no Teacher repository wrapper locally 
