...
from modules.auth.dependencies import get_current_user, require_school_portal, require_school_teacher, require_student
from modules.shared.models import User
from .repository import TestRepository
# Import TeacherRepository, StudentRepository from backup for now
...
async def create_test(
    ...
    test = await TestRepository.create(
        ...
        questions_data=[q.model_dump() for q in test_data.questions]
    )
...
async def update_test(
    ...
    updated_test = await TestRepository.update(db, test, **test_update.model_dump(exclude_unset=True))
    return updated_test
