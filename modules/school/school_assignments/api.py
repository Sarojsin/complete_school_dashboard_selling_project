...
from modules.auth.dependencies import get_current_user, require_school_portal, require_school_teacher, require_student, require_school_authority
from modules.shared.models import User
from .models import Assignment, AssignmentSubmission
from .repository import AssignmentRepository
# Import TeacherRepository, StudentRepository
...
async def grade_submission(
    ...
    updated_submission = await AssignmentRepository.update_submission(
        db, submission, **grade_data.model_dump(exclude_unset=True)
    )
...
async def update_assignment(
    ...
    updated_assignment = await AssignmentRepository.update(
        db, assignment, **assignment_update.model_dump(exclude_unset=True)
    )
